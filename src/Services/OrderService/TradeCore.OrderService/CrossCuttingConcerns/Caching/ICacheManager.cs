namespace TradeCore.OrderService.CrossCuttingConcerns.Caching
{
    /// <summary>
    ...
    public interface ICacheManager
    {
        ...
        Task<IEnumerable<T>> GetByPattern<T>(string key);
        Task<IEnumerable<T>> GetByPattern<T>(string key, int pageSize);
    }
}
