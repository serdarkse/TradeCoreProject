...
namespace TradeCore.EventBus.Base.SubManagers
{
    public class InMemoryEventSubscriptionManager : IEventBusSubscriptionManager
    {
        ...
        public InMemoryEventSubscriptionManager(Func<string, string> eventNameGetter)
        {
        ...
        private void AddSubscription(Type handlerType, string eventName)
        {
            ...
            if (_handlers[eventName].Any(a=>a.HandlerType == handlerType))
            {
        ...
        public SubscriptionInfo FindSubscriptionToRemove(string eventName, Type handlerType)
        {
            ...
            return _handlers[eventName].SingleOrDefault(a=>a.HandlerType==handlerType);
        }
        ...
        public Type GetEventTypeByName(string eventName) => _eventTypes.SingleOrDefault(a=>a.Name==eventName);
